...
public class ListviewAdapter2 extends BaseAdapter{
    ...
    ArrayList<Listviewitem2> datas;
    LayoutInflater inflater;

    public ListviewAdapter2(LayoutInflater inflater, ArrayList<Listviewitem2> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView text_name2= (TextView)convertView.findViewById(R.id.text_name2);
        TextView text_nation2= (TextView)convertView.findViewById(R.id.text_nation2);
        ImageView img_flag2= (ImageView)convertView.findViewById(R.id.img_flag2);

        //현재 position( getView()메소드의 첫번재 파라미터 )번째의 Data를 위 해당 View들에 연결..
        //WebSettings settings =  img_flag.getSettings();
        //img_flag.setHorizontalScrollBarEnabled(false); // 세로 스크롤 제거
        //img_flag.setVerticalScrollBarEnabled(false);

        text_name2.setText( datas.get(position).getName() );
        text_nation2.setText( datas.get(position).getNation() );
        img_flag2.setImageResource( datas.get(position).getImgId() );
